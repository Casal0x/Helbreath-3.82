...
public:
    ...
    // ============== Color Key ==============
    virtual void SetColorKey(uint16_t colorKey) = 0;
    virtual void SetColorKeyRGB(uint8_t r, uint8_t g, uint8_t b) = 0;

    // ============== Direct Pixel Access ==============
    // For sprites and effects that need direct pixel manipulation
    virtual uint16_t* Lock(int* pitch) = 0;
