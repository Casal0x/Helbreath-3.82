...
namespace game_limits {
    ...
    constexpr int max_bank_items       = 1000;
    constexpr int max_guildsmen        = 32;
    ...
    constexpr int max_build_items      = 100;
    constexpr int max_game_msgs        = 300;
    constexpr int max_guild_names      = 100;
    constexpr int max_sell_list        = 12;
    constexpr int max_party_members    = 8;
    constexpr int max_crusade_structures = 300;
...
#define DEF_MAXBUILDITEMS       game_limits::max_build_items
...
#define DEF_MAXPARTYMEMBERS         game_limits::max_party_members
#define DEF_MAXCRUSADESTRUCTURES    game_limits::max_crusade_structures
