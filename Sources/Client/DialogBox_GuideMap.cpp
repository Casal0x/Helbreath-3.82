...
void DialogBox_GuideMap::DrawLocationTooltip(short msX, short msY, short sX, short sY)
{
	...
	std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%d, %d", shX, shY);

	// Aresden map locations
	if (m_pGame->m_cMapIndex == 11)
	{
		if (shX > 46 && shX < 66 && shY > 107 && shY < 127) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_MAGICTOWER);
		else if (shX > 103 && shX < 123 && shY > 86 && shY < 116) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_GUILDHALL);
		else if (shX > 176 && shX < 196 && shY > 62 && shY < 82) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_CATH);
		else if (shX > 135 && shX < 155 && shY > 113 && shY < 133) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_CITYHALL);
		else if (shX > 97 && shX < 117 && shY > 175 && shY < 195) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_WAREHOUSE);
		else if (shX > 223 && shX < 243 && shY > 124 && shY < 144) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_WAREHOUSE);
		else if (shX > 118 && shX < 138 && shY > 157 && shY < 177) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_SHOP);
		else if (shX > 148 && shX < 178 && shY > 188 && shY < 208) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_BLACKSMITH);
		else if (shX > 69 && shX < 89 && shY > 199 && shY < 219) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_DUNGEON);
		else if (shX > 21 && shX < 41 && shY > 266 && shY < 286) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_HUNT);
		else if (shX > 20 && shX < 40 && shY > 13 && shY < 33) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_ML);
		else if (shX > 246 && shX < 266 && shY > 16 && shY < 36) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_ML);
		else if (shX > 265 && shX < 285 && shY > 195 && shY < 215) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_FARM);
		else if (shX > 88 && shX < 108 && shY > 150 && shY < 170) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_CMDHALL);
	}
	// Elvine map locations
	else if (m_pGame->m_cMapIndex == 3)
	{
		if (shX > 170 && shX < 190 && shY > 65 && shY < 85) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_MAGICTOWER);
		else if (shX > 67 && shX < 87 && shY > 130 && shY < 150) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_GUILDHALL);
		else if (shX > 121 && shX < 141 && shY > 66 && shY < 86) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_CATH);
		else if (shX > 135 && shX < 155 && shY > 117 && shY < 137) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_CITYHALL);
		else if (shX > 190 && shX < 213 && shY > 118 && shY < 138) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_WAREHOUSE);
		else if (shX > 73 && shX < 103 && shY > 165 && shY < 185) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_WAREHOUSE);
		else if (shX > 217 && shX < 237 && shY > 142 && shY < 162) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_SHOP);
		else if (shX > 216 && shX < 256 && shY > 99 && shY < 119) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_BLACKSMITH);
		else if (shX > 251 && shX < 271 && shY > 73 && shY < 93) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_DUNGEON);
		else if (shX > 212 && shX < 232 && shY > 13 && shY < 33) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_HUNT);
		else if (shX > 16 && shX < 36 && shY > 262 && shY < 282) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_ML);
		else if (shX > 244 && shX < 264 && shY > 248 && shY < 268) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_ML);
		else if (shX > 264 && shX < 284 && shY > 177 && shY < 207) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_FARM);
		else if (shX > 207 && shX < 227 && shY > 79 && shY < 99) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_CMDHALL);
	}
	// Elvine Farm
	else if (m_pGame->m_cMapIndex == 5)
	{
		if (shX > 62 && shX < 82 && shY > 187 && shY < 207) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_WAREHOUSE);
		else if (shX > 81 && shX < 101 && shY > 169 && shY < 189) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_SHOP);
		else if (shX > 101 && shX < 131 && shY > 180 && shY < 200) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_BLACKSMITH);
		else if (shX > 130 && shX < 150 && shY > 195 && shY < 215) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_DUNGEON);
		else if (shX > 86 && shX < 106 && shY > 139 && shY < 159) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_BARRACK);
	}
	// Aresden Farm
	else if (m_pGame->m_cMapIndex == 6)
	{
		if (shX > 30 && shX < 50 && shY > 80 && shY < 100) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_WAREHOUSE);
		else if (shX > 55 && shX < 85 && shY > 80 && shY < 100) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_BLACKSMITH);
		else if (shX > 52 && shX < 72 && shY > 80 && shY < 100) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_SHOP);
		else if (shX > 70 && shX < 90 && shY > 60 && shY < 80) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_DUNGEON);
		else if (shX > 45 && shX < 65 && shY > 123 && shY < 143) std::snprintf(m_pGame->G_cTxt, sizeof(m_pGame->G_cTxt), "%s", DEF_MSG_MAPNAME_BARRACK);
	}

	PutString(msX - 10, msY - 13, m_pGame->G_cTxt, GameColors::UIPaleYellow);
}
