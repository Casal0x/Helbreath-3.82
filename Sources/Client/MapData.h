...
public:
	...
	void GetOwnerStatusByObjectID(uint16_t wObjectID, char * pOwnerType, char * pDir, hb::shared::entity::PlayerAppearance * pAppearance, hb::shared::entity::PlayerStatus * pStatus, char * pName);
	...
	bool __fastcall bSetDeadOwner(uint16_t wObjectID, short sX, short sY, short sType, char cDir, const hb::shared::entity::PlayerAppearance& appearance, const hb::shared::entity::PlayerStatus& status, char * pName, short npcConfigId = -1);
	bool __fastcall bSetOwner(uint16_t wObjectID, int sX, int sY, int sType, int cDir, const hb::shared::entity::PlayerAppearance& appearance, const hb::shared::entity::PlayerStatus& status, char * pName, short sAction, short sV1, short sV2, short sV3, int iPreLoc = 0, int iFrame = 0, short npcConfigId = -1);
	bool __fastcall bGetOwner(short sX, short sY, char * pName, short * pOwnerType, hb::shared::entity::PlayerStatus * pOwnerStatus, uint16_t * pObjectID);
