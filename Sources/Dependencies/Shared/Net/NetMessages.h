...
namespace MsgId
{
	enum : uint32_t
	{
		...
		RequestCreateNewGuild                   = 0x0FC94208,
...
namespace CommonType
{
	enum : uint16_t
	{
		...
		SetExchangeItem                         = 0x0A1F,
		ConfirmExchangeItem                     = 0x0A20,
		CancelExchangeItem                      = 0x0A21,
...
namespace Notify
{
	enum : uint16_t
	{
		...
		SetExchangeItem                         = 0x0B5F,
		CancelExchangeItem                      = 0x0B60,
