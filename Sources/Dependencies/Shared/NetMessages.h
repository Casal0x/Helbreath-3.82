...
#define DEF_NOTIFY_STATUSTEXT						0x0B43  // Floating text above player's head
...
#define MSGID_NPCCONFIGURATIONCONTENTS				0x0FA314E4
#define MSGID_REQUEST_CONFIGDATA					0x0FA314E3
#define MSGID_NOTIFY_CONFIG_RELOAD					0x0FA314E5
