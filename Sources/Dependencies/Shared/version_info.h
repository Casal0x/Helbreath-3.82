...
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.2.24-alpha";
constexpr const char* full_version = "0.2.24-alpha+build.125";
} // namespace client

constexpr const char* build_timestamp = "2026-02-19T15:59:51";
