...
constexpr const char* stage = "alpha";
constexpr const char* display_version = "0.2.18-alpha";
constexpr const char* full_version = "0.2.18-alpha+build.114";
} // namespace client

constexpr const char* build_timestamp = "2026-02-19T14:39:33";
