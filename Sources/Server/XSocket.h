...
#define DEF_XSOCKEVENT_ONREAD                                                  \
  -124 // �޽����� �д� ���̴�.
#define DEF_XSOCKEVENT_READCOMPLETE                                            \
  -125 // �ϳ��� �޽����� ������
       // �����ߴ�.
#define DEF_XSOCKEVENT_UNKNOWN -126      // �˼����� �̺�Ʈ�̴�.
#define DEF_XSOCKEVENT_SOCKETCLOSED -127 // ������ ������.
#define DEF_XSOCKEVENT_BLOCK                                                   \
  -128 // �޽����� �����ٰ� ������ ������
       // �����̴�.
...
private:
  ...
  WSAEVENT m_hEvent; // MODERNIZED: WSAEventSelect event handle instead of
                     // window messages
