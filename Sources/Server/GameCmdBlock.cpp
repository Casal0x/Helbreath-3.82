...
bool GameCmdBlock::Execute(CGame* pGame, int iClientH, const char* pArgs)
{
	...
	{
		pGame->SendNotifyMsg(0, iClientH, DEF_NOTIFY_NOTICEMSG, 0, 0, 0, "Usage: /block CharName");
		return true;
	}
	...
	{
		pGame->SendNotifyMsg(0, iClientH, DEF_NOTIFY_NOTICEMSG, 0, 0, 0, "You cannot block yourself.");
		return true;
	}
